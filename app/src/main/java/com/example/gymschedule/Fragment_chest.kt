...
import com.example.gymschedule.ViewModels.ChestViewModel
...
class Fragment_chest : Fragment() {
    ...
    private lateinit var itemViewModel: ChestViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        itemViewModel = ViewModelProvider(this)[ChestViewModel::class.java]
